...
//     // Get current route to handle active states
//     const { url } = usePage();
...
export default function Sidebar() {
    ...
    useEffect(() => {
        // This effect will reset the dropdown to the relevant one based on the current URL
        ...
        // Add other conditionals as necessary for other sections
    }, [url]);
